private ["_onLadder","_itemorignal","_hasfooditem","_rawfood","_cookedfood","_invehicle","_hasoutput","_config","_text","_regen","_dis","_sfx","_itemtodrop","_nearByPile","_item","_display","_pos"];
